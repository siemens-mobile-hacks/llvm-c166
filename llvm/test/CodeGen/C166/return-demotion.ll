...
; RUN: llc -mtriple=c166-none-elf -verify-machineinstrs -filetype=obj \
; RUN:   -o %t.o < %s
...
; CHECK:       calls seg(_external_triple), sof(_external_triple)
; CHECK:       rets
...
; CHECK:       calls seg(_external_packed6), sof(_external_packed6)
