...
; RUN: llc -mtriple=c166-none-elf -code-model=tiny -o /dev/null \
; RUN:   -print-after=c166-atomic-lowering %t/tiny.ll 2>&1 | \
; RUN:   FileCheck %s --check-prefix=TINY
; RUN: llc -mtriple=c166-none-elf -code-model=large -target-abi=huge -o /dev/null \
; RUN:   -print-after=c166-atomic-lowering %t/huge.ll 2>&1 | \
...
; TINY: call addrspace(3) void @__atomic_load(i16 2, ptr addrspace(3) %object, ptr addrspace(3) {{%.*}}, i16 2)
; HUGE: call addrspace(1) void @__atomic_load(i16 2, ptr addrspace(5) %object, ptr addrspace(5) {{%.*}}, i16 2)
...
;--- tiny.ll
target datalayout = "e-m:u-P3-G3-A3-p:32:16-p1:32:16-p2:32:16:16:32-p3:16:16-p4:16:16-p5:32:16:16:32-p6:32:16:16:32-p7:16:16-p8:16:16-i32:16-i64:16-f32:16-f64:16-a:0:16-n8:16-S16-ni:2"
target triple = "c166-none-elf"

define i16 @load(ptr addrspace(3) %object) addrspace(3) {
  %value = load atomic i16, ptr addrspace(3) %object acquire, align 2
  ret i16 %value
}

;--- huge.ll
target datalayout = "e-m:u-P1-G5-A5-p:32:16-p1:32:16-p2:32:16:16:32-p3:16:16-p4:16:16-p5:32:16:16:32-p6:32:16:16:32-p7:16:16-p8:16:16-i32:16-i64:16-f32:16-f64:16-a:0:16-n8:16-S16-ni:2"
target triple = "c166-none-elf"

define i16 @load(ptr addrspace(5) %object) addrspace(1) {
  %value = load atomic i16, ptr addrspace(5) %object acquire, align 2
  ret i16 %value
}
