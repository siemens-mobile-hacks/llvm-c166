...
// RUN: llvm-objdump -dr %t-large.o | FileCheck %s --check-prefix=LARGE
...
// The same helpers remain inter-segment ordinary functions in Large.
// LARGE-LABEL: <_mul_long>:
// LARGE:       calls
// LARGE:       R_C166_SEG8 ___mulsi3
// LARGE-NEXT:  {{.*}}R_C166_SOF16 ___mulsi3
// LARGE-LABEL: <_shift_long>:
// LARGE:       calls
// LARGE:       R_C166_SEG8 ___ashlsi3
// LARGE-NEXT:  {{.*}}R_C166_SOF16 ___ashlsi3
// LARGE-LABEL: <_add_float>:
// LARGE:       calls
// LARGE:       R_C166_SEG8 ___addsf3
// LARGE-NEXT:  {{.*}}R_C166_SOF16 ___addsf3
// LARGE-LABEL: <_add_double>:
// LARGE:       calls
// LARGE:       R_C166_SEG8 ___adddf3
// LARGE-NEXT:  {{.*}}R_C166_SOF16 ___adddf3
// LARGE-LABEL: <_load_atomic_long>:
// LARGE:       calls
// LARGE:       R_C166_SEG8 ___atomic_load
// LARGE-NEXT:  {{.*}}R_C166_SOF16 ___atomic_load
